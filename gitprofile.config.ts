...
const CONFIG = {
  github: {
    username: 'aaguilar02', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Andres Aguilar',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'andres-aguilar1122',
    x: '',
    mastodon: '',
    researchGate: '',
    facebook: '',
    ...
    skype: '',
    telegram: '',
    website: 'https://aaguilar02.github.io',
    phone: '',
    email: 'aaguilar120@csustan.edu',
  },
  resume: {
    fileUrl:
